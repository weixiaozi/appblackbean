...
public class CollectionListAdapter extends BaseQuickAdapter<CollectionInnerBean, CollectionListAdapter.ContentHolder> {
    ...
    public CollectionListAdapter(@Nullable List<CollectionInnerBean> data) {
    ...
    @Override
    protected void convert(ContentHolder helper, CollectionInnerBean item) {
        if (mDensity == 0) {
        ...
        if (isManager) {
            helper.getView(R.id.llayout_collect_root).scrollTo(-ArmsUtils.dip2px(mContext, 48), 0);
        } else {
            helper.getView(R.id.llayout_collect_root).scrollTo(0, 0);
        }
        ...
        helper.getView(R.id.iv_collect_news).setVisibility(item.getN() == 1 ? View.VISIBLE : View.GONE);
        helper.getView(R.id.iv_collect_select).setSelected(item.isSelect());
        GlideApp.with(mContext).load(item.getAuthor_userportrait_thumb()).override(48).placeholder(R.drawable.icon_head_default).error(R.drawable.icon_head_default).into((CircleImageView) helper.getView(R.id.iv_head));
        helper.setText(R.id.txt_name, item.getAuthor_username());
        helper.setText(R.id.txt_time, item.getFollowed_at2());
        if (TextUtils.isEmpty(item.getThread_content())) {
            ...
            helper.setText(R.id.txt_theme_content, SpanUtil.getExpressionString(mContext, item.getThread_content(),
        ...
        helper.setText(R.id.txt_theme_topicname, item.getTopic_name());
        helper.setText(R.id.txt_theme_info, item.getThread_commentscn() + " 回复  " + item.getThread_likecn() + " 赞");
        ...
        if (item.getVideoType() == 1) {
            ...
            if (size == 1) {
                ...
                helper.getView(R.id.iv_theme_onepic).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mListen != null) {
                            mListen.clickPic(helper.getLayoutPosition());
                        }
...
//                    mVoiceAnimation.start();
       ...
       /* if (item.getThread_img() != null && item.getThread_img().getThumb() != null
                && item.getThread_img().getThumb().size() > 0) {
            int size = item.getThread_img().getThumb().size();
            ...
            if (size == 1) {
                ...
                GlideApp.with(mContext).load(item.getThread_img().getThumb().get(0)).override(172).placeholder(R.drawable.icon_theme_default).error(R.drawable.icon_theme_default).into((ImageView) helper.getView(R.id.iv_pic1));
            } else if (size == 2) {
                helper.getView(R.id.iv_pic1).setVisibility(View.VISIBLE);
                helper.getView(R.id.iv_pic2).setVisibility(View.VISIBLE);
                helper.getView(R.id.iv_pic3).setVisibility(View.GONE);
                GlideApp.with(mContext).load(item.getThread_img().getThumb().get(0)).override(172).placeholder(R.drawable.icon_theme_default).error(R.drawable.icon_theme_default).into((ImageView) helper.getView(R.id.iv_pic1));
                GlideApp.with(mContext).load(item.getThread_img().getThumb().get(1)).override(172).placeholder(R.drawable.icon_theme_default).error(R.drawable.icon_theme_default).into((ImageView) helper.getView(R.id.iv_pic2));
            } else {
                helper.getView(R.id.iv_pic1).setVisibility(View.VISIBLE);
                helper.getView(R.id.iv_pic2).setVisibility(View.VISIBLE);
                ...
                GlideApp.with(mContext).load(item.getThread_img().getThumb().get(0)).override(172).placeholder(R.drawable.icon_theme_default).error(R.drawable.icon_theme_default).into((ImageView) helper.getView(R.id.iv_pic1));
                GlideApp.with(mContext).load(item.getThread_img().getThumb().get(1)).override(172).placeholder(R.drawable.icon_theme_default).error(R.drawable.icon_theme_default).into((ImageView) helper.getView(R.id.iv_pic2));
                GlideApp.with(mContext).load(item.getThread_img().getThumb().get(2)).override(172).placeholder(R.drawable.icon_theme_default).error(R.drawable.icon_theme_default).into((ImageView) helper.getView(R.id.iv_pic3));
            }

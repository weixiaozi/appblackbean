...
public class ChatRepublishPoppubWindow implements View.OnClickListener {
    ...
    public ChatRepublishPoppubWindow(Activity context) {
        this.mContext = context;
        LayoutInflater inflater = LayoutInflater.from(context);
        mShareview = inflater.inflate(R.layout.chat_republish_popupwindow, null);

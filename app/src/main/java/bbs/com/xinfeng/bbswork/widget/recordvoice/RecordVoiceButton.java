package bbs.com.xinfeng.bbswork.widget.recordvoice;
...
public class RecordVoiceButton extends Button {
    ...
    private void initDialogAndStartRecord() {
        ...
        cardviewBg = (CardView) recordIndicator.findViewById(IdHelper.getViewID(mContext, "cardview_bg"));
                ...
                if (restTime > 0) {
                    ...
                    if (!controller.mTimeUp) {
                        if (msg.what < CANCEL_RECORD) {
                            ...
                            controller.cardviewBg.setCardBackgroundColor(controller.mContext.getResources().getColor(R.color.record_normal_bg));
                        } else {
                            controller.mRecordHintTv.setText(controller.mContext
                                    .getString(IdHelper.getString(controller.mContext, "jmui_cancel_record_voice_hint")));
                            controller.cardviewBg.setCardBackgroundColor(controller.mContext.getResources().getColor(R.color.record_cancel_bg));

package bbs.com.xinfeng.bbswork.utils.shortvideo.videorecord.view;
...
public class VideoWorkProgressFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        joiner_iv_loading = (ImageView) mContentView.findViewById(R.id.joiner_iv_loading);
...
//        animationDrawable = (AnimationDrawable) joiner_iv_loading.getDrawable();
    ...
    public void setDesTxt(String msg) {
        if (mTvTips != null)
            mTvTips.setText(msg);
    }

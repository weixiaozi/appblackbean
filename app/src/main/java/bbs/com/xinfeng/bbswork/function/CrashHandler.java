...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void collectDeviceInfo(Context ctx) {
        ...
        contentValues.put("Version", SystemUtil.getAppVersion() + "");
        contentValues.put("Channel", "");
        contentValues.put("Model", Build.MODEL);
        contentValues.put("System", SystemUtil.getSystemVersion());
        contentValues.put("Time", formatter.format(new Date()));
        /*try {

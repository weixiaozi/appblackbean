...
public class BlackListAdapter extends BaseQuickAdapter<MyBlackListBean.DataBean, BaseViewHolder> {

    public BlackListAdapter(@Nullable List<MyBlackListBean.DataBean> data) {
        super(R.layout.item_blacklist, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MyBlackListBean.DataBean item) {

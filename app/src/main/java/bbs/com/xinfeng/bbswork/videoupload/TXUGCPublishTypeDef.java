...
public class TXUGCPublishTypeDef {
    ...
    public final static class TXPublishParam {
        ...
        public int type;//自定义：2：语音3：视频
        public int duration;//自定义：时长
        public String key;//自定义：标识
        public int width;//视频宽
        public int height;//视频高
        public int level;//1:一级回复2：二级回复（语音）
    }
    ...
    public final static class TXPublishResult {
        ...
        public int type;//自定义：1:视频2：语音
        public String localPath;//自定义：视频本地路径
        public int duration;//自定义：时长
        public String key;//自定义：标识
        public int width;
        public int height;
        public int level;//1:一级回复2：二级回复
    }

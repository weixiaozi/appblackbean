...
public class UserInfoModel extends NetModel {
    public UserInfoModel(NetContract.OnDataLoadingListener dataLoadingListener, Activity activity) {
    ...
    public void getUserInfoList(int userid, int page, int tag) {
        ...
        params.put("page", page + "");
        packageData(retrofitService.getUserInfoList(params), tag);
    }

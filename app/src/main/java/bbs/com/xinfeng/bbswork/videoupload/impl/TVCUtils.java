package bbs.com.xinfeng.bbswork.videoupload.impl;
...
public class TVCUtils {
    ...
    public static String getDevUUID(Context context, String simulateIDFA) {
        ...
        try {
            String userIdFilePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/blackbean/spuid";
        ...
        if (userIdFromFile.isEmpty()) {
            ...
            try {
                String userIdDirPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/blackbean";

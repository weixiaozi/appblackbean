...
public class ChatOperatePoppubWindow implements View.OnClickListener {
    private final LinearLayout llayoutRoot;
    private final TextView txtCollect;
    ...
    public ChatOperatePoppubWindow(Activity context) {
        this.mContext = context;
        LayoutInflater inflater = LayoutInflater.from(context);
        mShareview = inflater.inflate(R.layout.chatoperate_popupwindow, null);
        ...
        TextView txtReply = (TextView) mShareview.findViewById(R.id.txt_pop_reply);
        TextView txtAt = (TextView) mShareview.findViewById(R.id.txt_pop_at);
        txtCollect = (TextView) mShareview.findViewById(R.id.txt_pop_collect);
        ...
        switch (view.getId()) {
            case R.id.txt_pop_reply:
                if (mListener != null)
                    mListener.onReply();
                break;
            case R.id.txt_pop_at:
                if (mListener != null)
                    mListener.onAt();
                break;
            case R.id.txt_pop_collect:
                if (mListener != null)
                    mListener.onCollect();
                break;

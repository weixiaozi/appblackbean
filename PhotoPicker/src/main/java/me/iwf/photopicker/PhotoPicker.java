...
public class PhotoPicker {
    ...
    public final static String EXTRA_SHOW_SEND = "SHOW_SEND_BUTTON";
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setShowSendButton(boolean isShowSend) {
            mPickerOptionsBundle.putBoolean(EXTRA_SHOW_SEND, isShowSend);
            return this;
        }

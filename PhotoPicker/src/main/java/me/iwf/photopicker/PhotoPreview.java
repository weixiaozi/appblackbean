...
public class PhotoPreview {
    ...
    public final static int REQUEST_Normal_CODE = 666;
    public final static int REQUEST_Other_CODE = 777;

    public static int REQUEST_CODE = REQUEST_Normal_CODE;

    public final static String EXTRA_CURRENT_ITEM = "current_item";
    public final static String EXTRA_PHOTOS = "photos";
    public final static String EXTRA_THUM_PHOTOS = "thum_photos";
    ...
    public static class PhotoPreviewBuilder {
        ...
        public PhotoPreviewBuilder() {
            ...
            REQUEST_CODE = REQUEST_Normal_CODE;
        }
        ...
        public PhotoPreviewBuilder setRequestCode(int code) {
            REQUEST_CODE = code;
            return this;
        }

        public PhotoPreviewBuilder setThumPhotos(ArrayList<String> photoPaths) {
            mPreviewOptionsBundle.putStringArrayList(EXTRA_THUM_PHOTOS, photoPaths);
            return this;
        }

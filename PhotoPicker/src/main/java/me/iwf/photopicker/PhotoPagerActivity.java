...
import static me.iwf.photopicker.PhotoPreview.EXTRA_THUM_PHOTOS;
...
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> thumPaths = getIntent().getStringArrayListExtra(EXTRA_THUM_PHOTOS);
        ...
        pagerFragment.setPhotos(paths, thumPaths, currentItem);

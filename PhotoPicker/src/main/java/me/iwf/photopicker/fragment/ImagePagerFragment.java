...
public class ImagePagerFragment extends Fragment {
    ...
    private ArrayList<String> thumPaths;
    ...
    public void setPhotos(List<String> paths, List<String> thumPaths, int currentItem) {
        this.paths.clear();
        this.paths.addAll(paths);
        if (thumPaths != null) {
            this.thumPaths.clear();
            this.thumPaths.addAll(thumPaths);
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new PhotoPagerAdapter(getActivity(), Glide.with(this), paths, thumPaths);
    }

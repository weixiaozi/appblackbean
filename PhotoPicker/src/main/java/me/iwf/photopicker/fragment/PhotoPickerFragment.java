...
public class PhotoPickerFragment extends Fragment {
    ...
    private final static String EXTRA_PREVIEW = "preview";
    ...
    private boolean hasPreviewBtn;
    private Button buttonPreview;
    private int selectedItemCount;

    public static PhotoPickerFragment newInstance(boolean isPreview, boolean showCamera, boolean showGif,
                                                  boolean previewEnable, int column, int maxCount, ArrayList<String> originalPhotos) {
        Bundle args = new Bundle();
        args.putBoolean(EXTRA_PREVIEW, isPreview);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        hasPreviewBtn = getArguments().getBoolean(EXTRA_PREVIEW, false);
    ...
    public void onResume() {
        ...
        if (getActivity() instanceof PhotoPickerActivity) {
            ...
            updatePreviewStatus(photoGridAdapter.getSelectedItemCount());
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonPreview = (Button) rootView.findViewById(R.id.button_preview);
        buttonPreview.setVisibility(hasPreviewBtn ? View.VISIBLE : View.GONE);
        buttonPreview.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImagePagerFragment imagePagerFragment =
                        ImagePagerFragment.newInstance(photos, 0);
    ...
    public void updatePreviewStatus(int selectedItemCount) {
        this.selectedItemCount = selectedItemCount;
        if (selectedItemCount > 0) {
            buttonPreview.setClickable(true);
            buttonPreview.setText(getString(R.string.__picker_preview_with_count, selectedItemCount));
        } else {
            buttonPreview.setClickable(false);
            buttonPreview.setText(getString(R.string.__picker_preview));
        }
    }
}
